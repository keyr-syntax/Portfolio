  ...
  return (
    <>
      <div id="resume" className="mt-[20px] mb-5 mx-auto">
        ...
        <p className="flex flex-row justify-start items-center gap-2 p-2 my-6 mx-auto w-[80%] max-w-[500px] text-[18px] text-center text-white rounded border border-solid border-borderColor">
